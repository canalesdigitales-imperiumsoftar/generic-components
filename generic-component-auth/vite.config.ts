...
export default defineConfig({
  plugins: [
    react(),
    dts({ insertTypesEntry: true, tsconfigPath: './tsconfig.app.json' , include: ['src'],  }), // Asegura que los tipos se generen
  ...
  build: {
    ...
    lib: {
      ...
      name: 'generic-component-auth', // Nombre global para UMD/IIFE
      fileName: (format) => `generic-component-auth.${format}.js`,
    },
    rollupOptions: {
